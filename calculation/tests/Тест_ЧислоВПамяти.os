...
Процедура ТестДолжен_ПроверитьСохранениеЗначенийВЧислоВПамяти() Экспорт
	...
	Ожидаем.Что(ЧислоВПамяти.Получить(), "Ожидаем, число 10 сохранилось в памяти объекта ЧислоВПамяти")
		.Равно(10);
...
Процедура ТестДолжен_ПроверитьВыбросИсключенияПриСохраненииСтроки() Экспорт
	...
	Исключение
		...
		Ожидаем.Что(ОписаниеОшибки(), "Описание ошибки содержит информацию о неверном аргументе")
